...
class ReportFoundationController extends Controller
{
    ...
    {
        return view('reports.foundations');
    }
    ...
    public function generatePDF(Request $request)
    {
        ...
        // Today's date and Institution data
        $now = date('Y_m_d_h_i_s');
        $institution = Institution::find(1);
        $institution_emblem_base64 = base64_encode(Storage::get('/public/emblem/' . $institution->emblem));
        $data = '';
        ...
        $data = compact('table', 'data', 'institution', 'institution_emblem_base64', 'columns');

        $pdf = PDF::loadView('reports/foundations_pdf', $data)->setPaper($request->size, $request->orientation);
    ...
    public function generatePDFs(Request $request)
    {
        ...
        $data = compact('table', 'data', 'institution', 'institution_emblem_base64');

        // return view()->share('data',$data);
        $pdf = PDF::loadView('reports/foundations_pdf', $data)->setPaper('a4', 'landscape');
