...
<head>
    ...
    <title>Inscripciones - Ficha Academica</title>
...
<body>
    <div id="header" style="">
        <div style="padding: 0px;">
            ...
            <div style="display: inline-block; margin-left: 25px; margin-top: 7px;">
                ...
                <p style="font-size: 12px;">Inscripcion - Ficha Academica</p>
            </div>
        </div>
    </div>
    ...
    <p>
        <span class="text-bold">Tipo de Documento:</span>
        <span>{{ $inscripcion->estudiante->documento_tipo }}</span>
    </p>

    <p>
        <span class="text-bold">Numero de Documento:</span>
        <span>{{ $inscripcion->estudiante->documento_numero }}</span>
    </p>

    <p>
        <span class="text-bold">Nacionalidad:</span>
        <span>{{ $inscripcion->estudiante->nacionalidad->nombre }}</span>
    </p>

    <p>
        <span class="text-bold">Fecha de Nacimiento:</span>
        <span>{{ $inscripcion->estudiante->fecha_nacimiento }}</span>
    </p>

    <p>
        <span class="text-bold">Sexo:</span>
        <span>{{ $inscripcion->estudiante->sexo }}</span>
    </p>

    <p>
        <span class="text-bold">Guardian:</span>
        <span>{{ $inscripcion->estudiante->guardian->nombre }} {{ $inscripcion->estudiante->guardian->apellido }}</span>
    </p>

    <h5 class="text-center">Informacion Academico</h5>
