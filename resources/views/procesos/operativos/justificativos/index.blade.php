...
<script>
    ...
    function updateTableData() {
        $('#datatable').DataTable({
            ...
            ajax: {
                type: "GET",
                url: "/procesos/operativos/justificativos/get/justificativos",
                data: {
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        if (data.estado == 'Activo') {
                            return `
                                <a href="/procesos/operativos/justificativos/${data.id}" class="btn btn-sm btn-primary me-1">
                                    <i class="fa fa-search"></i>
                                </a>

                                <a href="/procesos/operativos/justificativos/${data.id}/anull" class="btn btn-sm btn-primary me-1">
                                    <i class="fa fa-ban"></i>
                                </a>
                            `;
                        }
