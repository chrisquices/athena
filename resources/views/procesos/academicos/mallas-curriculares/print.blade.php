...
<body>
    <div id="header" style="">
        <div style="padding: 0px;">
            ...
            <div style="display: inline-block; margin-left: 25px; margin-top: 7px;">
                ...
                <p style="font-size: 12px;">Malla Curricular</p>
            </div>
        </div>
    </div>
    ...
    <p>
        <span class="text-bold">Bachillerato: </span>
        {{ $malla_curricular->bachillerato->nombre }}
    </p>
    <p>
        <span class="text-bold">Año: </span>
    ...
    <div id="content">
        <table id="table{{ $key }}" class="table">
            <thead>
                <tr>
                    <th>Curso</th>
                    <th>Plan</th>
            ...
            <tbody>
                @foreach ($malla_curricular_detalle as $subkey => $detalle)
                @if ($detalle->grado_id == $grado->id)

                <tr>
                    <td>{{ $grado->nombre ?? ' - '}}</td>
                    <td>{{ $detalle->plan ?? ' - '}}</td>
                    <td>{{ $detalle->asignatura->area->nombre ?? ' - '}}</td>
                    <td>{{ $detalle->asignatura->nombre ?? ' - '}}</td>
                    <td>{{ $detalle->horas_catedras ?? ' - '}}</td>
                </tr>
                @endif
    ...
    <footer>
        <p>Esta malla curricular fue generada el <span class="text-primary">{{ date('Y-m-d') }} {{ date('g:i A') }}</span>.</p>
    </footer>
