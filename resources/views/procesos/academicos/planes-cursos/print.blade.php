...
<body>
    <div id="header" style="">
        <div style="padding: 0px;">
            ...
            <div style="display: inline-block; margin-left: 25px; margin-top: 7px;">
                ...
                <p style="font-size: 12px;">Plan de Curso</p>
            </div>
        </div>
    </div>
    ...
    <p>
        ...
        {{ $plan_curso->sede->nombre }} ({{ $plan_curso->sede->acronimo }})
    </p>

    <p>
        <span class="text-bold">Malla Curricular: </span>
        {{ $plan_curso->malla_curricular->nombre }}
    </p>

    <p>
        <span class="text-bold">Grado: </span>
        {{ $plan_curso->grado->nombre }} ({{ $plan_curso->grado->nombre_alternativo }})
    </p>
    ...
    <p>
        <span class="text-bold">Sección: </span>
        {{ $plan_curso->seccion }}
    </p>

    <p>
        <span class="text-bold">Promedio Requerido: </span>
        {{ $plan_curso->promedio_requerido }}
    </p>

    <p>
        <span class="text-bold">Fecha de Inicio: </span>
        {{ $plan_curso->fecha_inicio }}
    </p>

    <p>
        <span class="text-bold">Fecha de Finalización: </span>
        {{ $plan_curso->fecha_fin }}
    </p>
