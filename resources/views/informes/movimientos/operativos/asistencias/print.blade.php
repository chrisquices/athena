...
<table class="table">
    ...
    <tr>
        ...
        @isset($columnas['contrato_id']) <th>Contrato</th> @endisset
        @isset($columnas['horario_detalle_id']) <th>Horario</th> @endisset
        @isset($columnas['reemplazante_id']) <th>Reemplazante</th> @endisset
    ...
    @foreach ($registros as $registro)
        <tr>
            ...
            @isset($columnas['contrato_id']) <td>{{ $registro->contrato->id }} / {{ $registro->contrato->postulante->nombre }} {{ $registro->contrato->postulante->apellido }}</td> @endisset
            @isset($columnas['horario_detalle_id']) <td>{{ $registro->horario_detalle->hora_desde }} - {{ $registro->horario_detalle->hora_hasta }}</td> @endisset
            @isset($columnas['reemplazante_id']) <td>{{ $registro->reemplazante->nombre ?? '-'}} {{ $registro->reemplazante->apellido ?? ''}}</td> @endisset
