...
<head>
    ...
    <title>Justificativos Operativos</title>
...
<table class="table">
    ...
    <tr>
        ...
        @isset($columnas['asistencia_operativo_id']) <th>Asistencia Fecha</th> @endisset
    ...
    @foreach ($registros as $registro)
        <tr>
            ...
            @isset($columnas['asistencia_operativo_id']) <td>{{ $registro->asistencia_operativo->fecha }}</td> @endisset
            ...
            @isset($columnas['causa_id']) <td>{{ $registro->causa->nombre }}</td> @endisset
