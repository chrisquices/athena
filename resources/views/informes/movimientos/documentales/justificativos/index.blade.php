                    ...
                    <div class="row">
                        ...
                        <div id="container_columns" class="col-lg-12 mb-4">
                            ...
                            <ul id="columns" class="list-group">
                                ...
                                <li class="list-group-item">
                                    <div class="form-check">
                                        <input id="columna_asistencia_documental_id" name="columnas[asistencia_documental_id]" class="form-check-input" type="checkbox" checked>
                                        <label class="form-check-label" for="columna_asistencia_documental_id">Asistencia / Fecha</label>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="form-check">
