                ...
                <form action="{{ route('informes-movimientos-documentales-print') }}">
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <select id="estudiante_id" name="estudiante_id" class="form-control select2">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <select id="plan_curso_id" name="plan_curso_id" class="form-control select2">
                        ...
                        <div id="container_columns" class="col-lg-12 mb-4">
                            ...
                            <ul id="columns" class="list-group">
                                ...
                                <li class="list-group-item">
                                    <div class="form-check">
                                        <input id="columna_estudiante_id" name="columnas[estudiante_id]" class="form-check-input" type="checkbox" checked>
                                        <label class="form-check-label" for="columna_estudiante_id">Estudiante</label>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="form-check">
                                ...
                                <li class="list-group-item">
                                    <div class="form-check">
                                        <input id="columna_procedencia" name="columnas[procedencia]" class="form-check-input" type="checkbox" checked>
                                        <label class="form-check-label" for="columna_procedencia">Procedencia</label>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="form-check">
