            ...
            <div class="card-body">
                <form action="{{ route('informes-movimientos-documentales-print') }}">
                    <div class="row">
                        ...
                        <input type="hidden" name="tabla" value="sanciones">
                        ...
                        <div id="container_columns" class="col-lg-12 mb-4">
                            ...
                            <ul id="columns" class="list-group">
                                ...
                                <li class="list-group-item">
                                    <div class="form-check">
                                        <input id="columna_tipo" name="columnas[tipo]" class="form-check-input" type="checkbox" checked>
                                        <label class="form-check-label" for="columna_tipo">Tipo</label>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="form-check">
