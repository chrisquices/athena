                    ...
                    <div class="row">
                        ...
                        <div id="container_columns" class="col-lg-12 mb-4">
                            ...
                            <ul id="columns" class="list-group">
                                ...
                                <li class="list-group-item">
                                    <div class="form-check">
                                        <input id="columna_area_id" name="columnas[area_id]" class="form-check-input" type="checkbox" checked>
                                        <label class="form-check-label" for="columna_area_id">Area</label>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="form-check">
                                ...
                                <li class="list-group-item">
                                    <div class="form-check">
                                        <input id="columna_acronimo" name="columnas[acronimo]" class="form-check-input" type="checkbox" checked>
                                        <label class="form-check-label" for="columna_acronimo">Acronimo</label>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="form-check">
