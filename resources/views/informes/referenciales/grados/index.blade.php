            ...
            <div class="card-body">
                <form action="{{ route('informes-referenciales-print') }}">
                    <div class="row">
                        ...
                        <input type="hidden" name="tabla" value="grados">
                        ...
                        <div id="container_columns" class="col-lg-12 mb-4">
                            ...
                            <ul id="columns" class="list-group">
                                ...
                                <li class="list-group-item">
                                    <div class="form-check">
                                        <input id="columna_nombre_alternativo" name="columnas[nombre_alternativo]" class="form-check-input" type="checkbox" checked>
                                        <label class="form-check-label" for="columna_nombre_alternativo">Nombre Alternativo</label>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="form-check">
                                        <input id="columna_nivel" name="columnas[nivel]" class="form-check-input" type="checkbox" checked>
                                        <label class="form-check-label" for="columna_nivel">Nivel</label>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="form-check">
                                        <input id="columna_nivel_acronimo" name="columnas[nivel_acronimo]" class="form-check-input" type="checkbox" checked>
                                        <label class="form-check-label" for="columna_nivel_acronimo">Nivel Acronimo</label>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="form-check">
                                        <input id="columna_tiene_bachillerato" name="columnas[tiene_bachillerato]" class="form-check-input" type="checkbox" checked>
                                        <label class="form-check-label" for="columna_tiene_bachillerato">Tiene Bachillerato</label>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="form-check">
