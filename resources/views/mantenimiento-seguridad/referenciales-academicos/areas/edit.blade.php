    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('areas-update', ['area' => $area->id]) }}" method="POST" autocomplete="off">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div>
                                ...
                                <input id="nombre" name="nombre" class="form-control" type="text" value="{{ old('nombre') ?? $area->nombre }}">
                            </div>
                        </div>
                    </div>
