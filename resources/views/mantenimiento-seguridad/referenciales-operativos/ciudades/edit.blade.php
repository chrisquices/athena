    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('ciudades-update', ['ciudad' => $ciudad->id]) }}" method="POST" autocomplete="off">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div>
                                ...
                                <input id="nombre" name="nombre" class="form-control" type="text" value="{{ old('nombre') ?? $ciudad->nombre }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div>
                                ...
                                <input id="acronimo" name="acronimo" class="form-control" type="text" value="{{ old('acronimo') ?? $ciudad->acronimo }}">
                            </div>
                        </div>
                    </div>
