                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div>
                                ...
                                <input id="apellido" name="apellido" class="form-control" type="text" value="{{ old('apellido') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div>
                                ...
                                <input id="documento_numero" name="documento_numero" class="form-control" type="text" value="{{ old('documento_numero') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div>
                                ...
                                <select name="nacionalidad_id" id="nacionalidad_id" class="form-control select2">
                                    ...
                                    <option value="{{ $nacionalidad->id }}" @if(old('nacionalidad_id')==$nacionalidad->id) selected @endif>{{ $nacionalidad->nombre }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div>
                                ...
                                <input id="fecha_nacimiento" name="fecha_nacimiento" class="form-control" type="date" value="{{ old('fecha_nacimiento') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div>
                                ...
                                <select name="guardian_id" id="guardian_id" class="form-control select2">
                                    ...
                                    <option value="{{ $guardian->id }}" @if(old('guardian_id')==$guardian->id) selected @endif>{{ $guardian->documento_numero }} - {{ $guardian->nombre }} {{ $guardian->apellido }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
