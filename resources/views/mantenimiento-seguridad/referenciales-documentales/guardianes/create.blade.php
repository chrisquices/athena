...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('guardianes-store') }}" method="POST" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div>
                                ...
                                <select name="ciudad_id" id="ciudad_id" class="form-control select2">
                                    ...
                                    <option value="{{ $ciudad->id }}" @if(old('ciudad_id')==$ciudad->id) selected @endif>{{ $ciudad->nombre }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div>
                                ...
                                <input id="direccion" name="direccion" class="form-control" type="text" value="{{ old('direccion') }}">
                            </div>
                        </div>
