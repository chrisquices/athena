    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('usuarios-update', ['user' => $user->id]) }}" method="POST" autocomplete="off">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            <div>
                                ...
                                <select name="role" id="role" class="form-control select2">
                                    ...
                                    <option value="Secretario" @if($user->role=='Secretario' ) selected @endif>Secretario</option>
                                    <option value="Docente" @if($user->role=='Docente' ) selected @endif>Docente</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div>
                                ...
                                <input id="lastname" name="lastname" class="form-control" type="text" value="{{ old('lastname') ?? $user->lastname}}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            <div>
                                ...
                                <input id="email" name="email" class="form-control" type="text" value="{{ old('email') ?? $user->email}}">
                            </div>
                        </div>
