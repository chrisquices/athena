                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-2">
                        <form action="/movimientos/planes/evaluaciones">
                            <select name="curso_id" id="curso_id" class="form-control select2 select2-reset" onchange="this.form.submit()">
                                <option></option>
                    ...
                    <div class="col-12 col-lg-2">
                        <form action="/movimientos/planes/evaluaciones">
                            ...
                            <select name="asignatura_id" id="asignatura_id" class="form-control select2 select2-reset" onchange="this.form.submit()">
                                <option></option>
