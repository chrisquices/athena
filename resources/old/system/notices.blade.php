@section('title', 'Avisos y Actividades')
                        ...
                        <div class="card-body">
                            <form id="form" class="form-modal" autocomplete="off">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input id="title" name="title" type="search" class="form-control" required>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Contenido</label>
                                    <textarea id="content" name="content" type="text" class="form-control" rows="7" required></textarea>
                                </div>
...
@section('scripts')
    <script src="{{ asset('assets/js/pages/system/notices.js') }}"></script>
@endsection
