                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link mb-2 active" id="v-pills-ciudades-tab"
                                   data-bs-toggle="pill"
                                   href="#v-pills-ciudades" role="tab"
                                   aria-controls="v-pills-ciudades"
                                   aria-selected="true">Ciudades</a>

                                <a class="nav-link mb-2" id="v-pills-clausulas-tab" data-bs-toggle="pill"
                                   href="#v-pills-clausulas" role="tab" aria-controls="v-pills-clausulas">Cláusulas</a>

                                <a class="nav-link mb-2" id="v-pills-causas-tab" data-bs-toggle="pill"
                                   href="#v-pills-causas" role="tab" aria-controls="v-pills-causas">Causas</a>
                            </div>
                        </div>
                        <div class="col-md-9">
                            <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">

                                <div class="tab-pane fade show active" id="v-pills-ciudades" role="tabpanel"
                                     aria-labelledby="v-pills-ciudades-tab">
                                    <form action="{{ route('referenciales-operativos-pdf') }}">
                                        <div class="row">
                                ...
                                <div class="tab-pane fade" id="v-pills-clausulas" role="tabpanel"
                                     aria-labelledby="v-pills-clausulas-tab">
                                    <form action="{{ route('referenciales-operativos-pdf') }}">
                                        <div class="row">
                                            <div class="col-lg-6 mb-4">
                                                <label for="created_at_from" class="form-label">Fecha Desde</label>
                                ...
                                <div class="tab-pane fade" id="v-pills-causas" role="tabpanel"
                                     aria-labelledby="v-pills-causas-tab">
                                    <form action="{{ route('referenciales-operativos-pdf') }}">
                                        <div class="row">
                                            <div class="col-lg-6 mb-4">
                                                <label for="created_at_from" class="form-label">Fecha Desde</label>
